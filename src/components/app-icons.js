...
export const companyIcon = html`
    <svg height="24" viewBox="0 0 24 24" width="24">
        <path d="M18,15H16V17H18M18,11H16V13H18M20,19H12V17H14V15H12V13H14V11H12V9H20M10,7H8V5H10M10,11H8V9H10M10,15H8V13H10M10,19H8V17H10M6,7H4V5H6M6,11H4V9H6M6,15H4V13H6M6,19H4V17H6M12,7V3H2V21H22V7H12Z" />
    </svg>`;
    
export const volumeIcon = html`
    <svg height="24" viewBox="0 0 24 24" width="24">
...
export const arrowRightIcon = html`
    <svg style="width:24px ;height:24px" viewBox="0 0 24 24">
        <path d="M4,11V13H16L10.5,18.5L11.92,19.92L19.84,12L11.92,4.08L10.5,5.5L16,11H4Z" />
    </svg>`;
    
export const weightIcon = html`
    <svg height="24" viewBox="0 0 24 24" width="24">
...
export const tabletIcon = html`
    <svg height="24" width="24" viewBox="0 0 24 24" style='fill-opacity: 0.4; stroke-width: 2.5px;'>
...
export const toolingIcon = html`
    <svg height="24" width="24" viewBox="0 0 24 24"  style='stroke-width: 0px'>
...
export const concavityIcon = html`
    <svg height="24" width="24" viewBox="0 0 24 24" style='fill-opacity: 0.4; stroke-width: 0.5px;'>
      <path d="m 2 9 l 20 0 l 0 6 l -20 0 l 0 -6"></path>
